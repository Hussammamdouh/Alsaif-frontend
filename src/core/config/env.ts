...
const Config = {
  API_BASE_URL: extra.apiBaseUrl || 'https://api.alsaifanalysis.com', // Default to clean custom domain
...
export const ENV = {
   ...
   * API Configuration
   */
  API_BASE_URL: Config.API_BASE_URL || 'https://api.alsaifanalysis.com',
